# Microflow Detailed Specification: Val_Schedule_IntervalType_Required
...
2. 🔀 **DECISION:** `$Schedule/TaskQueueScheduler.Schedule_TaskQueue!=empty and $Schedule/TaskQueueScheduler.Schedule_TaskQueue/TaskQueueScheduler.TaskQueue/AllowScheduling`
   ➔ **If [true]:**
      1. 🔀 **DECISION:** `$Schedule/IntervalType!=empty`
         ➔ **If [true]:**
            1. 🏁 **END:** Return `''`
         ➔ **If [false]:**
            1. **Create Variable **$Validation** = `'Interval type' + $Message`**
