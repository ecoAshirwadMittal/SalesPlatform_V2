# Microflow Detailed Specification: ACT_BidDataDoc_ExportExcel_SubmittedBidSheet_Round3
...
4. 🔀 **DECISION:** `$Auction_MostRecent!= empty`
   ➔ **If [false]:**
      ...
      2. 🏁 **END:** Return empty
   ➔ **If [true]:**
      1. **DB Retrieve **AuctionUI.SchedulingAuction** Filter: `[ AuctionUI.SchedulingAuction_Auction = $Auction_MostRecent and Round = 3 ]` (Result: **$SchedulingAuction**)**
