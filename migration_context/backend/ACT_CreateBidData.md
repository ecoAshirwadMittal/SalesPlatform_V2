# Microflow Detailed Specification: ACT_CreateBidData
...
2. **Create Variable **$BidQuantityDefault** = `empty`**
3. **Retrieve related **BidRound_BuyerCode** via Association from **$BidRound** (Result: **$BuyerCode_2**)**
4. **Retrieve related **BidRound_SchedulingAuction** via Association from **$BidRound** (Result: **$SchedulingAuction**)**
5. 🔀 **DECISION:** `$BidRound != empty`
   ...
   ➔ **If [true]:**
      ...
      - Set **MaximumQuantity** = `if $MatchingBidDataTotalQuantityConfig_1!=empty then if($BuyerCode/BuyerCodeType = AuctionUI.enum_BuyerCodeType.Data_Wipe) then $IteratorAgregatedInventory_DW/TotalQuantity+$MatchingBidDataTotalQuantityConfig_1/DataWipeQuantity else $IteratorAgregatedInventory_DW/TotalQuantity+$MatchingBidDataTotalQuantityConfig_1/DataWipeQuantity + $MatchingBidDataTotalQuantityConfig_1/NonDWQuantity else $IteratorAgregatedInventory_DW/TotalQuantity`
      ...
      - Set **Data_Wipe_Quantity** = `if $MatchingBidDataTotalQuantityConfig_1!=empty then if($BuyerCode/BuyerCodeType = AuctionUI.enum_BuyerCodeType.Data_Wipe) then $IteratorAgregatedInventory_DW/TotalQuantity+$MatchingBidDataTotalQuantityConfig_1/DataWipeQuantity else $IteratorAgregatedInventory_DW/TotalQuantity+$MatchingBidDataTotalQuantityConfig_1/DataWipeQuantity + $MatchingBidDataTotalQuantityConfig_1/NonDWQuantity else $IteratorAgregatedInventory_DW/TotalQuantity`
      ...
      - Set **BidData_BidRound** = `$BidRound`
      - Set **CompanyName** = `$NP_BuyerCodeSelect_Helper/CompanyName`
      - Set **MaximumQuantity** = `if $MatchingBidDataTotalQuantityConfig!=empty then if($BuyerCode/BuyerCodeType = AuctionUI.enum_BuyerCodeType.Data_Wipe) then $IteratorAgregatedInventory/TotalQuantity+$MatchingBidDataTotalQuantityConfig/DataWipeQuantity else $IteratorAgregatedInventory/TotalQuantity+$MatchingBidDataTotalQuantityConfig/DataWipeQuantity + $MatchingBidDataTotalQuantityConfig/NonDWQuantity else $IteratorAgregatedInventory/TotalQuantity`
      - Set **BidRound** = `$CurrentBidRound`
      - Set **PreviousRoundBidAmount** = `$PreviousRoundBidData/BidAmount`
      - Set **PreviousRoundBidQuantity** = `$PreviousRoundBidData/BidQuantity`
      - Set **BidData_BuyerCode** = `$BuyerCode`
      - Set **BidData_BidDataDoc** = `$BidDataDoc`
      - Set **Round2BidRank** = `$PreviousRoundBidData/Round2BidRank`
      - Set **DisplayRound2BidRank** = `$PreviousRoundBidData/DisplayRound2BidRank`**
      ...
      - Set **BidData_BuyerCode** = `$BuyerCode`
      - Set **BidData_BidDataDoc** = `$BidDataDoc`
      - Set **Round2BidRank** = `$ExistingBidData/Round2BidRank`
      - Set **DisplayRound2BidRank** = `$ExistingBidData/DisplayRound2BidRank`**
                                                   │             2. **Update **$IteratorAgregatedInventory**
      - Set **isTotalQuantityModified** = `if $MatchingBidDataTotalQuantityConfig!=empty then true else false`**
      ...
      - Set **BidData_BuyerCode** = `$BuyerCode`
      - Set **BidData_BidDataDoc** = `$BidDataDoc`
      - Set **Round2BidRank** = `$PreviousRoundFindBidData/Round2BidRank`
      - Set **DisplayRound2BidRank** = `$PreviousRoundFindBidData/DisplayRound2BidRank`**
                                                   │                   2. **Update **$IteratorAgregatedInventory**
      - Set **isTotalQuantityModified** = `if $MatchingBidDataTotalQuantityConfig!=empty then true else false`**
