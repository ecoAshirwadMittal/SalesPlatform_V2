# Microflow Analysis: DS_GetOfferSummaryTotal
...
2. **Search the Database for **EcoATM_PWS.Offer** using filter: { [OfferStatus != empty]
...
8. **Update the **$undefined** (Object):
      - Change [EcoATM_PWS.OffersUiHelper.OfferStatus] to: "empty
"
