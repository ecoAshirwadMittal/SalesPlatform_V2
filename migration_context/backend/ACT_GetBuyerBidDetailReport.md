# Microflow Detailed Specification: ACT_GetBuyerBidDetailReport
...
3. **Retrieve related **BuyerCodeSelectSearchHelper_BuyerCode** via Association from **$BuyerCodeSelectSearch_Helper** (Result: **$BuyerCode**)**
