# Microflow Analysis: DS_GetSPAttributeConsumingService_InitialLogin
...
2. **Take the list **$SPAttributeConsumingServiceList**, perform a [Find] where: { SAML20.Enum_Attribute_Consuming_Login_Type.Initial_Login }, and call the result **$SPAttributeConsumingServiceIndex****
