# Microflow Detailed Specification: DS_GetOfferSummaryOrdered
...
2. **DB Retrieve **EcoATM_PWS.Offer** Filter: `[OfferStatus = 'Ordered' or OfferStatus = 'Pending_Order']` (Result: **$OfferList**)**
3. **AggregateList**
4. **AggregateList**
5. **AggregateList**
6. **AggregateList**
...
8. **Update **$OffersUiHelper** (and Save to DB)
      - Set **OfferStatus** = `$ENUM_PWSOrderStatus`
