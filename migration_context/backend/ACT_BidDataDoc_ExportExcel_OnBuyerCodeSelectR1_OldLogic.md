# Microflow Detailed Specification: ACT_BidDataDoc_ExportExcel_OnBuyerCodeSelectR1_OldLogic
...
2. 🔀 **DECISION:** `$MxTemplate!=empty`
   ➔ **If [true]:**
      1. **Create Variable **$FileName** = `$NP_BuyerCodeSelect_Helper/Code+'_'+ trim(replaceAll(replaceAll($BidderRouterHelper/CurrYearWeek, ' ', ''),'/','_'))+ '_'+'Round1.xlsx'`**
