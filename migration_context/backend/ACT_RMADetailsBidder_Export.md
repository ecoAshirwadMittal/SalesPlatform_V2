# Microflow Detailed Specification: ACT_RMADetailsBidder_Export
...
5. **DB Retrieve **XLSReport.MxTemplate** Filter: `[Name = 'PWSRMADetailsBidder']` (Result: **$MxTemplate**)**
6. **Create Variable **$FileName** = `$RMA/Number + '_Details_' + formatDateTime([%CurrentDateTime%], 'yyyyMMdd') +'.xlsx'`**
