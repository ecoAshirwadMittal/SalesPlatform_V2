# Microflow Analysis: ACT_RMADetailSales_Export_PendingApproval
...
5. **Search the Database for **XLSReport.MxTemplate** using filter: { [Name = 'PWSRMADetailsSalesPendingApproval']
