# Microflow Detailed Specification: ACT_RMAItem_SalesDeclineAll

### 📥 Inputs (Parameters)
- **$RMA** (Type: EcoATM_RMA.RMA)

### ⚙️ Execution Flow (Logic Steps)
1. **Create Variable **$TimerName** = `'DeclineAll'`**
2. **Create Variable **$Description** = `'DeclineAll RMA [Number:'+$RMA/Number+']'`**
...
5. 🔄 **LOOP:** For each **$IteratorRMAItem** in **$RMAItemList**
   │ 1. **Update **$IteratorRMAItem**
      - Set **Status** = `EcoATM_RMA.ENUM_RMAItemStatus.Decline`**
   └─ **End Loop**
