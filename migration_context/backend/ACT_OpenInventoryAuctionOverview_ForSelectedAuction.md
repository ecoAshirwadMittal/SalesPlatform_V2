# Microflow Detailed Specification: ACT_OpenInventoryAuctionOverview_ForSelectedAuction
...
4. **List Operation: **FindByExpression** on **$undefined** where `$currentObject/AuctionUI.SchedulingAuction_Helper_Auction=$SelectedAuction` (Result: **$SchedulingAuction_Helper_Auction**)**
