# Microflow Detailed Specification: ACT_RMADetailSales_Export_PendingApproval
...
5. **DB Retrieve **XLSReport.MxTemplate** Filter: `[Name = 'PWSRMADetailsSalesPendingApproval']` (Result: **$MxTemplate**)**
