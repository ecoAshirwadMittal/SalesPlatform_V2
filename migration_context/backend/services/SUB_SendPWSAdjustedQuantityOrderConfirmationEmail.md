# Microflow Detailed Specification: SUB_SendPWSAdjustedQuantityOrderConfirmationEmail
...
3. **DB Retrieve **Email_Connector.EmailTemplate** Filter: `[TemplateName='PWSAdjustedQtyOrderConfirmation']` (Result: **$EmailTemplate**)**
