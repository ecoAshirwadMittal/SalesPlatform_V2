# Microflow Analysis: SUB_LoadPWSInvetory_UpdateColorProperty

### Execution Steps:
1. **Run another process: "Custom_Logging.SUB_Log_Info"**
2. **Java Action Call
      - Store the result in a new variable called **$NewColorList****
3. **Decision:** "exist?"
   - If [true] -> Move to: **Activity**
   - If [false] -> Move to: **Finish**
4. **Create List
      - Store the result in a new variable called **$ColorList****
