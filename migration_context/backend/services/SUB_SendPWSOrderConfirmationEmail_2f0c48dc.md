# Microflow Analysis: SUB_SendPWSOrderConfirmationEmail
...
3. **Search the Database for **Email_Connector.EmailTemplate** using filter: { [TemplateName='PWSOrderConfirmation']
