# Microflow Analysis: SUB_Import_MxColumnSettings
...
### Execution Steps:
1. **Retrieve
      - Store the result in a new variable called **$MxColumnSettingsList****
2. **Create List
      - Store the result in a new variable called **$MxColumnSettingsCommitList****
