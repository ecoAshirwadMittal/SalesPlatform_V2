# Microflow Analysis: SUB_Change_ExistingDevice_B_NYY_D_NNY
...
1. **Update the **$undefined** (Object):
      - Change [AuctionUI.AllBidDownload.MAXofGradeB_NYY_D_NNY] to: "'$'+toString($AggregatedInventory/AvgTargetPrice)"
      - Change [AuctionUI.AllBidDownload.B_NYY_D_NNYEstimatedQuantity] to: "$AggregatedInventory/TotalQuantity"**
