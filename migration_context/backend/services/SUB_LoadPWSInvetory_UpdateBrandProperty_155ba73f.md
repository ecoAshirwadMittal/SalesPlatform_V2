# Microflow Analysis: SUB_LoadPWSInvetory_UpdateBrandProperty

### Execution Steps:
1. **Run another process: "Custom_Logging.SUB_Log_Info"**
2. **Java Action Call
      - Store the result in a new variable called **$NewBrandList****
3. **Decision:** "exist?"
   - If [true] -> Move to: **Activity**
   - If [false] -> Move to: **Finish**
4. **Create List
      - Store the result in a new variable called **$BrandList****
...
10. **Java Action Call
      - Store the result in a new variable called **$UpdateBrand****
