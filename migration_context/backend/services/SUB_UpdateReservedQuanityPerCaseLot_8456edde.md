# Microflow Analysis: SUB_UpdateReservedQuanityPerCaseLot

### Requirements (Inputs):
- **$CaseLotList** (A record of type: EcoATM_PWSMDM.CaseLot)
...
[EcoATM_PWS.OfferItem_Device/EcoATM_PWSMDM.Device/ItemType='SPB']
