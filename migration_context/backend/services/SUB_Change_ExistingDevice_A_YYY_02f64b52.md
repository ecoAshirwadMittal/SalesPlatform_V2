# Microflow Analysis: SUB_Change_ExistingDevice_A_YYY
...
1. **Update the **$undefined** (Object):
      - Change [AuctionUI.AllBidDownload.MAXofGradeA_YYY] to: "'$'+toString($AggregatedInventory/AvgTargetPrice)"
      - Change [AuctionUI.AllBidDownload.A_YYYEstimatedQuantity] to: "$AggregatedInventory/TotalQuantity"**
