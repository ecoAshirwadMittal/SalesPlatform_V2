# Microflow Analysis: SUB_SendFirstReminderEmail
...
2. **Search the Database for **Email_Connector.EmailTemplate** using filter: { [TemplateName='PWSCounterOfferFirstReminderEmail']
