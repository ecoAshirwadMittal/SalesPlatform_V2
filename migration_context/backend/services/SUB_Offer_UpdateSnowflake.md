# Microflow Detailed Specification: SUB_Offer_UpdateSnowflake
...
3. 🔀 **DECISION:** `$FeatureFlagState`
   ➔ **If [true]:**
      1. **Call Microflow **EcoATM_PWS.SUB_Offer_ConvertToJSON** (Result: **$JSONContent**)**
      ...
      - Set **AGR_CONTENT** = `$updatedBy`**
            ...
            7. **Create Variable **$Storeproc** = `@EcoATM_PWS.SnowflakeEnvironmentDB +'.'+ @EcoATM_PWS.PWS_LoadOfferSPROC`**
