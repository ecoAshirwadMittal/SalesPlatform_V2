# Microflow Analysis: SUB_BidDataImport_NoRank
...
2. **Run another process: "EcoATM_BidData.SUB_BidDataImport_GetValidBidData"
...
4. **Run another process: "EcoATM_BidData.SUB_BidData_Transform"
