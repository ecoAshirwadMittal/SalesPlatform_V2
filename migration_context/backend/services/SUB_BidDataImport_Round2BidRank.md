# Microflow Detailed Specification: SUB_BidDataImport_Round2BidRank
...
2. **Call Microflow **EcoATM_BidData.SUB_BidDataImport_GetValidBidData_Round2BidRank** (Result: **$ExcelImport_BidData**)**
3. 🔀 **DECISION:** `$ExcelImport_BidData != empty`
   ➔ **If [true]:**
      1. **Call Microflow **EcoATM_BidData.SUB_BidData_Transform_Roun2BidRank** (Result: **$BidData_ToCOmmit**)**
