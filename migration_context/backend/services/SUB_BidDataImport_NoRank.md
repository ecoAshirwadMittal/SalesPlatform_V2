# Microflow Detailed Specification: SUB_BidDataImport_NoRank
...
2. **Call Microflow **EcoATM_BidData.SUB_BidDataImport_GetValidBidData** (Result: **$ExcelImport_BidData**)**
3. 🔀 **DECISION:** `$ExcelImport_BidData != empty`
   ➔ **If [true]:**
      1. **Call Microflow **EcoATM_BidData.SUB_BidData_Transform** (Result: **$BidData_ToCOmmit**)**
