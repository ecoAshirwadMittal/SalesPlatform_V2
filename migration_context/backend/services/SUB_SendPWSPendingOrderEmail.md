# Microflow Detailed Specification: SUB_SendPWSPendingOrderEmail
...
3. **DB Retrieve **Email_Connector.EmailTemplate** Filter: `[TemplateName='PWSPendingOrder']` (Result: **$EmailTemplate**)**
4. 🔀 **DECISION:** `$EmailTemplate!=empty`
   ...
   ➔ **If [true]:**
      ...
      10. **Create **EcoATM_PWS.PWSEmailNotification** (Result: **$NewPWSEmailNotification**)
      ...
      11. **DB Retrieve **EcoATM_PWS.PWSConstants**  (Result: **$PWSFeatureConfig**)**
      12. **Update **$EmailTemplate**
      - Set **To** = `$PWSFeatureConfig/SalesEmail`**
      13. **JavaCallAction**
