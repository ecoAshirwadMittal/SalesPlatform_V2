# Microflow Detailed Specification: SUB_LoadPWSInvetory_UpdateGradeProperty
...
3. 🔀 **DECISION:** `$NewBrandList!=empty`
   ➔ **If [true]:**
      ...
      2. 🔄 **LOOP:** For each **$IteratorBrand** in **$NewBrandList**
         │ 1. **Create **EcoATM_PWSMDM.Grade** (Result: **$NewBrand**)
      - Set **Grade** = `$IteratorBrand/Value`**
         │ 2. **Call Microflow **Custom_Logging.SUB_Log_Info****
         │ 3. **Add **$$NewBrand
** to/from list **$GradeList****
         └─ **End Loop**
      3. **Commit/Save **$GradeList** to Database**
