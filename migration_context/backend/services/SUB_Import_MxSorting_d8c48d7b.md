# Microflow Analysis: SUB_Import_MxSorting
...
### Execution Steps:
1. **Retrieve
      - Store the result in a new variable called **$MxSortingList****
2. **Create List
      - Store the result in a new variable called **$MxSortingCommitList****
