# Microflow Analysis: SUB_Change_ExistingDevice_F_NYN_H_NNN_DW
...
1. **Update the **$undefined** (Object):
      - Change [AuctionUI.AllBidDownload.MAXofGradeF_NYN_H_NNN] to: "'$'+toString($AggregatedInventory/DWAvgTargetPrice)"
      - Change [AuctionUI.AllBidDownload.F_NYN_H_NNNEstimatedQuantity] to: "$AggregatedInventory/DWTotalQuantity"**
