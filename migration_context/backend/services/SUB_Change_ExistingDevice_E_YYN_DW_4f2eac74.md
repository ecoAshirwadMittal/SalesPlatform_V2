# Microflow Analysis: SUB_Change_ExistingDevice_E_YYN_DW
...
1. **Update the **$undefined** (Object):
      - Change [AuctionUI.AllBidDownload.MAXofGradeE_YYN] to: "'$'+toString($AggregatedInventory/DWAvgTargetPrice)"
      - Change [AuctionUI.AllBidDownload.E_YYNEstimatedQuantity] to: "$AggregatedInventory/DWTotalQuantity"**
...
4. **Update the **$undefined** (Object):
      - Change [AuctionUI.AllBidDownload.E_YYNQuantityCap] to: "empty"**
5. **Decision:** "Bid Amount
Not empty?"
   - If [false] -> Move to: **Activity**
   - If [true] -> Move to: **Activity**
6. **Update the **$undefined** (Object):
      - Change [AuctionUI.AllBidDownload.E_YYN] to: "'$0.00'"**
