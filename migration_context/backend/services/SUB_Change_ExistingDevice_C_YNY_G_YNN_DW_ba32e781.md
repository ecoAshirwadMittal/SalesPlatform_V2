# Microflow Analysis: SUB_Change_ExistingDevice_C_YNY_G_YNN_DW
...
1. **Update the **$undefined** (Object):
      - Change [AuctionUI.AllBidDownload.MAXofGradeC_YNY_G_YNN] to: "'$'+toString($AggregatedInventory/DWAvgTargetPrice)"
      - Change [AuctionUI.AllBidDownload.C_YNY_G_YNNEstimatedQuantity] to: "$AggregatedInventory/DWTotalQuantity"**
