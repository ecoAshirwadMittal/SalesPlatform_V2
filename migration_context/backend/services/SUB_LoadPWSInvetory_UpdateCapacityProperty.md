# Microflow Detailed Specification: SUB_LoadPWSInvetory_UpdateCapacityProperty

### ⚙️ Execution Flow (Logic Steps)
1. **Call Microflow **Custom_Logging.SUB_Log_Info****
2. **JavaCallAction**
3. 🔀 **DECISION:** `$NewCapacityList!=empty`
   ➔ **If [true]:**
      1. **CreateList**
      2. 🔄 **LOOP:** For each **$IteratorCapacity** in **$NewCapacityList**
         │ 1. **Create **EcoATM_PWSMDM.Capacity** (Result: **$NewCapacity**)
      - Set **Capacity** = `$IteratorCapacity/Value`**
         │ 2. **Call Microflow **Custom_Logging.SUB_Log_Info****
         │ 3. **Add **$$NewCapacity
** to/from list **$CapacityList****
         └─ **End Loop**
      3. **Commit/Save **$CapacityList** to Database**
