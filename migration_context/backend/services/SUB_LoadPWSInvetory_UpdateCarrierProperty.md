# Microflow Detailed Specification: SUB_LoadPWSInvetory_UpdateCarrierProperty

### ⚙️ Execution Flow (Logic Steps)
1. **Call Microflow **Custom_Logging.SUB_Log_Info****
2. **JavaCallAction**
3. 🔀 **DECISION:** `$NewCarrierList!=empty`
   ➔ **If [true]:**
      1. **CreateList**
      2. 🔄 **LOOP:** For each **$IteratorCarrier** in **$NewCarrierList**
         │ 1. **Create **EcoATM_PWSMDM.Carrier** (Result: **$NewColor**)
      - Set **Carrier** = `$IteratorCarrier/Value`**
         │ 2. **Call Microflow **Custom_Logging.SUB_Log_Info****
         │ 3. **Add **$$NewColor
** to/from list **$CarrierList****
         └─ **End Loop**
      3. **Commit/Save **$CarrierList** to Database**
