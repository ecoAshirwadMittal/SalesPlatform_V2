# Microflow Analysis: SUB_Change_ExistingDevice_E_YYN
...
1. **Update the **$undefined** (Object):
      - Change [AuctionUI.AllBidDownload.MAXofGradeE_YYN] to: "'$'+toString($AggregatedInventory/AvgTargetPrice)"
      - Change [AuctionUI.AllBidDownload.E_YYNEstimatedQuantity] to: "$AggregatedInventory/TotalQuantity"**
