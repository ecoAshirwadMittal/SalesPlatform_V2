# Microflow Analysis: SUB_SendPWSAdjustedQuantityOrderConfirmationEmail
...
3. **Search the Database for **Email_Connector.EmailTemplate** using filter: { [TemplateName='PWSAdjustedQtyOrderConfirmation']
