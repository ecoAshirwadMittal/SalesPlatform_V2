# Microflow Analysis: SUB_Change_ExistingDevice_F_NYN_H_NNN
...
1. **Update the **$undefined** (Object):
      - Change [AuctionUI.AllBidDownload.MAXofGradeF_NYN_H_NNN] to: "'$'+toString($AggregatedInventory/AvgTargetPrice)"
      - Change [AuctionUI.AllBidDownload.F_NYN_H_NNNEstimatedQuantity] to: "$AggregatedInventory/TotalQuantity"**
