# Microflow Analysis: SUB_GenerateReservedQuantityForCaseLot

### Requirements (Inputs):
- **$CaseLot** (A record of type: EcoATM_PWSMDM.CaseLot)

### Execution Steps:
1. **Search the Database for **EcoATM_PWS.OfferItem** using filter: { [EcoATM_PWS.OfferItem_CaseLot=$CaseLot]
