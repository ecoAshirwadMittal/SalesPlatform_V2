# Microflow Analysis: ACT_AllListing_ExportExcel
...
4. **Search the Database for **EcoATM_PWSMDM.Device** using filter: { [ATPQty!= empty and ATPQty> 0 and IsActive] } (Call this list **$DeviceList**)**
5. **Search the Database for **XLSReport.MxTemplate** using filter: { [Name = 'PWSOrder']
...
11. **Create Variable**
12. **Run another process: "EcoATM_PWS.SUB_OrderData_GenerateReport"** ⚠️ *(This step has a safety catch if it fails)*
13. **Delete**
