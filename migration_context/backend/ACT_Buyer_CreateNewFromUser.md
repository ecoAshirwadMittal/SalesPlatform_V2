# Microflow Detailed Specification: ACT_Buyer_CreateNewFromUser

### 📥 Inputs (Parameters)
- **$EcoATMDirectUser** (Type: EcoATM_UserManagement.EcoATMDirectUser)

### ⚙️ Execution Flow (Logic Steps)
1. **Create **EcoATM_BuyerManagement.NewBuyerHelper** (Result: **$NewBuyerHelper_1**)
      - Set **NewBuyerHelper_EcoATMDirectUser** = `$EcoATMDirectUser`
      - Set **SourcePage** = `'user'`**
2. **Create **EcoATM_BuyerManagement.Buyer** (Result: **$NewBuyer_1**)
