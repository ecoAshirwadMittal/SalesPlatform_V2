...
- 📦 **DataView** [MF: EcoATM_PWS.DS_GetOrCreatePWSOrderMDMHelper]
  - 📦 **DataView** [Context]
  - 📦 **DataView** [MF: EcoATM_PWS.SUB_FetchPWSSearchObject] [DP: {Spacing right: Outer large}]
    - 🖼️ **Image**: pws_search [DP: {Spacing left: Outer small}]
      ↳ [EnterKeyPress] → **Microflow**: `EcoATM_PWS.OCE_TriggerGridSearch`
      ↳ [acti] → **Microflow**: `EcoATM_PWS.ACT_PWSInventory_Confidential`
    - 📑 **TabContainer** [Class: `inventory-container` | DP: {Style: Lined}]
      - 📑 **Tab**: "Functional Devices"
        - 🧩 **Data grid 2** [Class: `pws-datagrid column-selector-no-styling pws-order-datagrid` | DP: {Spacing top: Outer large, Spacing left: Outer large}] (ID: `com.mendix.widget.web.datagrid.Datagrid`)
            - refreshInterval: 0
...
`
      ...
      - 📑 **Tab**: "Functional Case Lots" 👁️ (If: `$dataView8/EnableCaseLots`)
        - 🧩 **Image** [DP: {Spacing top: Outer small}] (ID: `com.mendix.widget.web.image.Image`)
            - datasource: icon
            - onClickType: action
            - widthUnit: auto
            - width: 100
            ...
            - iconSize: 16
            - displayAs: fullImage
        - 🧩 **Data grid 2** [Class: `pws-datagrid column-selector-no-styling pws-order-datagrid` | Dynamic: `'pws-caselots-footer'` | DP: {Spacing top: Outer large, Spacing left: Outer large}] (ID: `com.mendix.widget.web.datagrid.Datagrid`)
            - refreshInterval: 0
            - itemSelectionMethod: checkbox
            - itemSelectionMode: clear
            ➤ **columns**
