...
- 🧩 **Data grid 2** (ID: `com.mendix.widget.web.datagrid.Datagrid`)
    ...
    ➤ **columns**
        ...
        - alignment: left
        - showContentAs: attribute
        - attribute: [Attr: EcoATM_PWSMDM.Capacity.IsEnabledForFilter]
        ...
        - alignment: left
        - showContentAs: attribute
        - attribute: [Attr: EcoATM_PWSMDM.Capacity.Rank]
        - header: Rank
        ➤ **filter** (Widgets)
        ...
        - attribute: [Attr: EcoATM_PWSMDM.Capacity.Capacity]
        ➤ **content** (Widgets)
            ↳ [acti] → **Page**: `EcoATM_PWSMDM.Capacity_NewEdit`
            ↳ [acti] → **Microflow**: `EcoATM_PWSMDM.ACT_Capacity_DeleteByAdmin`
        - visible: `true`
        - filterCaptionType: expression
        - hidable: no
        - width: autoFit
