...
- 🧩 **Data grid 2** (ID: `com.mendix.widget.web.datagrid.Datagrid`)
    ...
    ➤ **columns**
        ...
        - alignment: left
        - showContentAs: attribute
        - attribute: [Attr: EcoATM_PWSMDM.Color.IsEnabledForFilter]
        ...
        - alignment: left
        - showContentAs: attribute
        - attribute: [Attr: EcoATM_PWSMDM.Color.Rank]
        - header: Rank
        ➤ **filter** (Widgets)
        ...
        - attribute: [Attr: EcoATM_PWSMDM.Color.Color]
        ➤ **content** (Widgets)
            ↳ [acti] → **Page**: `EcoATM_PWSMDM.Color_NewEdit`
            ↳ [acti] → **Microflow**: `EcoATM_PWSMDM.ACT_Color_DeleteByAdmin`
        - visible: `true`
        - filterCaptionType: expression
        - hidable: no
        - width: autoFit
