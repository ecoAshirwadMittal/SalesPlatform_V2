...
- 📦 **DataView** [Context]
  - 🧩 **Data grid 2** (ID: `com.mendix.widget.web.datagrid.Datagrid`)
      ...
      ➤ **columns**
          ...
          - alignment: right
          - showContentAs: attribute
          - attribute: [Attr: EcoATM_PWS.BuyerOfferItem.CSSClass]
          - header: CSS class
          ➤ **filter** (Widgets)
          ...
          - attribute: [Attr: EcoATM_PWS.BuyerOfferItem.Quantity]
          ➤ **content** (Widgets)
              ↳ [acti] → **Page**: `EcoATM_PWS.BuyerOfferItem_NewEdit`
              ↳ [acti] → **Microflow**: `EcoATM_PWS.ACT_BuyerOfferItem_DeleteByAdmin`
          - visible: `true`
          - filterCaptionType: expression
          - hidable: no
          - width: autoFit
