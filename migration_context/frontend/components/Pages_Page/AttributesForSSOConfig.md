...
- 📦 **DataView** [Context]
  - 📦 **DataGrid** [MF: SAML20.MF_AvailableAttributesForSSOConfig]
    - ⚡ **Button**: Select [Style: Default]
      ↳ [acti] → **Microflow**: `SAML20.MB_SelectAttribute`
    - ⚡ **Button**: New [Style: Default]
      ↳ [acti] → **Microflow**: `SAML20.MB_NewAttribute`
