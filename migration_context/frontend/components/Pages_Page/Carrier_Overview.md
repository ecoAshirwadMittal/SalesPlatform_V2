...
- 🧩 **Data grid 2** (ID: `com.mendix.widget.web.datagrid.Datagrid`)
    ...
    ➤ **columns**
        ...
        - alignment: left
        - showContentAs: attribute
        - attribute: [Attr: EcoATM_PWSMDM.Carrier.IsEnabledForFilter]
        ...
        - alignment: left
        - showContentAs: attribute
        - attribute: [Attr: EcoATM_PWSMDM.Carrier.Rank]
        - header: Rank
        ➤ **filter** (Widgets)
        ...
        - attribute: [Attr: EcoATM_PWSMDM.Carrier.Carrier]
        ➤ **content** (Widgets)
            ↳ [acti] → **Page**: `EcoATM_PWSMDM.Carrier_NewEdit`
            ↳ [acti] → **Microflow**: `EcoATM_PWSMDM.ACT_Carrier_DeleteByAdmin`
        - visible: `true`
        - filterCaptionType: expression
        - hidable: no
        - width: autoFit
