...
@Entity
@Table(name = "missing_device_lines", schema = "partial_credit")
public class MissingDeviceLine {
    ...
    private ShipStatus shipStatus = ShipStatus.UNKNOWN;
    ...
    public void setShipStatus(ShipStatus v) { this.shipStatus = v; }
