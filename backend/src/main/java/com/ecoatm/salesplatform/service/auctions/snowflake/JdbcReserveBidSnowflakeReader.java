...
public class JdbcReserveBidSnowflakeReader implements ReserveBidSnowflakeReader {

    private static final Logger log = LoggerFactory.getLogger(JdbcReserveBidSnowflakeReader.class);

    private final JdbcTemplate snowflakeJdbc;

    public JdbcReserveBidSnowflakeReader(@Qualifier("snowflakeDataSource") DataSource snowflakeDataSource) {
