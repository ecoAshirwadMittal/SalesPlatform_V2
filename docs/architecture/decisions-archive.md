# Architecture Decisions Log — Archive

Historical ADR entries moved out of `decisions.md` to reduce context
size. These remain the source of truth for the decisions they record;
they are still referenced by newer ADRs. Newest first.
