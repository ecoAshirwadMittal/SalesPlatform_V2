...
Output: backend/src/main/resources/db/migration/V81__data_auctions_purchase_order.sql
...
OUT_PATH = (
    ...
    / "backend/src/main/resources/db/migration/V81__data_auctions_purchase_order.sql"
)
...
def emit_sql(po_sql_rows, pod_resolved):
    lines = [
        "-- =============================================================================",
        "-- V81: auctions — purchase_order + po_detail data load",
