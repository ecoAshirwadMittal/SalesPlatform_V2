...
V77__data_auctions_reserve_bid.sql. Mirrors extract_qa_data.py CLI + FK-remap pattern.
"""
import argparse
import os
import subprocess
...
OUT_PATH = Path(__file__).parent.parent / "backend/src/main/resources/db/migration/V77__data_auctions_reserve_bid.sql"
