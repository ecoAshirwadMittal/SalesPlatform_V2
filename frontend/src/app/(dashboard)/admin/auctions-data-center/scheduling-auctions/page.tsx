...
/**
 * Operational Scheduling Auctions list — off-menu admin recovery surface.
 *
 * The left-nav "Auction Scheduling" item now lands on the active
 * auction's schedule editor (QA parity, see
 * `docs/tasks/auction-scheduling-menu-redirect-plan.md`). This page
 * preserves the per-round operational controls SalesOps still needs:
 * Start / Close / Re-rank / Recalc TP, plus the live "Next transition
 * in Xm Ys" countdown. Reachable by typing the URL directly.
 */
...
/**
 * 1Hz wall clock so each row's countdown re-renders without re-fetching.
 */
      ...
      <header className={styles.header}>
        <div style={{ marginRight: 'auto' }}>
          ...
          <p className={styles.subtitle}>
            Per-round operational view. The left-nav &quot;Auction Scheduling&quot; item now opens
            the active auction&apos;s schedule editor; this page survives for admin recovery
            (Start / Close / Re-rank / Recalc TP).
          </p>
        </div>
        <button
